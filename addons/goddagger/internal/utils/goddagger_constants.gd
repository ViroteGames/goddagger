...
const GODDAGGER_INSPECTOR_PROPERTY_SCOPE_SUFIX := "Scope"
const GODDAGGER_INSPECTOR_PROPERTY_MODULES_SUFIX := "Modules"
const GODDAGGER_INSPECTOR_PROPERTY_EXPOSED_DEPENDENCIES_SUFIX := "ExposedDependencies"
